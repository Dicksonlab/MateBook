...
void FileUtilities::removeDirectory(const QDir& directory)
{
	if (directory.exists()) {
...
void FileUtilities::copyDirectory(const QDir& source, const QDir& target)
{
	if (!source.exists()) {
...
void FileUtilities::moveDirectory(QDir& source, QDir& target)
{
