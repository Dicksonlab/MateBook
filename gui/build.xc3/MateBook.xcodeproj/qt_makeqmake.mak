...
QMAKE    = /usr/bin/qmake
MateBook.xcodeproj/project.pbxproj: MateBook.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o MateBook.xcodeproj/project.pbxproj MateBook.pro
