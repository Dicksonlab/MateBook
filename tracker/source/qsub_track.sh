...
MB_PATH=/groups/dickson/dicksonlab/MateBook
...
#  done
	...
	MB_BEGIN="$MB_BEGIN" \
	MB_END="$MB_END" \
	qsub -v MB_USER,MB_VERSION,MB_VIDEO,MB_OUTDIR,MB_SETTINGS,MB_PREPROCESS,MB_TRACK,MB_POSTPROCESS,MB_BEGIN,MB_END ${MB_PATH}/usr/bin/tracker/$MB_VERSION/track.sh
fi
