...
public:
	...
	void prepend(std::size_t begin, std::size_t end);
	...
	std::vector<std::size_t> begin;	// STL-like index of the first frame of the occlusion
	std::vector<std::size_t> end;	// STL-like index of the first frame after (!) the occlusion
